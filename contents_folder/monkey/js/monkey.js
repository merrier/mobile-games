...
/*   $(".loading").remove();*/
   ...
   /* user_group()
    ...
    function user_group(){
        var i=0;
        if(i==1){
            $(".oper_group").eq(1).show();
        }
        else{
            $(".oper_group").eq(0).show();
        }
    }*/
    //活动规则
    ...
    //点赞
    $(".h_f").click(function(){
       /* var li_1="<li class='cus_tr clearfix'>"+'<div class="cus_mess">'+
            "<ul>"+
           ' <li class="cus_li"><span class="sequence">'+'1'+'</span></li>'+
       ' <li class="cus_li"><img src="images/img9.png" class="img_responsive cus_img"/></li>'+
           '<li class="cus_li"><span class="cus_name">'+"无能"+'</span></li>'+
       ' </ul>'+
       ' </div>'+
        '<div class="cus_mess"><span class="cus_score">'+"12346"+'</span></div>'+"</li>"
        $(".cus_list").eq(0).children("ul").append(li_1);*/
