(function (b) {
    ...
    b.fn.fakeLoader = function (m) {
        ...
        d.each(function () {
            ...
            switch (n) {
                case"spinner1":
                    $(".fakeloader_box").html(s1);
                    break;
                case"spinner2":
                    $(".fakeloader_box").html(s2);
                    break;
                case"spinner3":
                    $(".fakeloader_box").html(s3);
                    break;
                case"spinner4":
                    $(".fakeloader_box").html(s4);
                    break;
                case"spinner5":
                    $(".fakeloader_box").html(s5);
                    break;
                case"spinner6":
                    $(".fakeloader_box").html(s6);
                    break;
                case"spinner7":
                    $(".fakeloader_box").html(s7);
                    break;
                default:
                    $(".fakeloader_box").html(s1)
            }
            ...
            if (f.imagePath != "") {
                d.html('<div class="fl"><images src="' + f.imagePath + '"></div>');
                a()
            }
        });
