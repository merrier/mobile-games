...
$(function () {
    ...
    function start(deg) {
        ...
        clearInterval(timer);
        //-------------设置中几等奖的概率-----------
        if (deg == prizeDeg4[0] || deg == prizeDeg5[0] || deg == prizeDeg6[0] || deg == prizeDeg7[0]) {
            prize = 1;
        }
        else if (deg == prizeDeg4[1] || deg == prizeDeg5[1] || deg == prizeDeg6[1] || deg == prizeDeg7[1]) {
            prize = 2;
        }
        else if (deg == prizeDeg4[2] || deg == prizeDeg5[2] || deg == prizeDeg6[2] || deg == prizeDeg7[2]) {
            prize = 3;
        }
        else if (deg == prizeDeg5[3] || deg == prizeDeg6[3] || deg == prizeDeg7[3]) {
            prize = 4;
        }
        else if (deg == prizeDeg6[4] || deg == prizeDeg7[4]) {
            prize = 5;
        }
        else if (deg == prizeDeg7[5]) {
            prize = 6;
        }
        else {
            prize = 7;
